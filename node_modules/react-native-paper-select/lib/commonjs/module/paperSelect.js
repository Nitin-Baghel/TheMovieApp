...
const PaperSelect = ({
  ...
  const {
    height
  } = _reactNative.Dimensions.get('window'); // console.log(height);
  ...
  })) : null, multiEnable === true && selectAllEnable === true ? /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    style: styles.touchableItem,
    onPress: () => {
      _checkAll();
    }
  ...
  })), /*#__PURE__*/_react.default.createElement(_reactNativePaper.Dialog.Actions, null, /*#__PURE__*/_react.default.createElement(_reactNativePaper.Button, {
